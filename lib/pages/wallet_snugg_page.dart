...
class WalletSnuggPage extends StatefulWidget {
  const WalletSnuggPage({super.key});

  @override
  State<WalletSnuggPage> createState() => _WalletSnuggPageState();
}

class _WalletSnuggPageState extends State<WalletSnuggPage> {
