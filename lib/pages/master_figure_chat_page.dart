...
class MasterFigureChatPage extends StatefulWidget {
  final Character character;

  const MasterFigureChatPage({
    super.key,
    required this.character,
  });

  @override
  State<MasterFigureChatPage> createState() => _MasterFigureChatPageState();
}

class _MasterFigureChatPageState extends State<MasterFigureChatPage> {
  ...
  void _sendWelcomeMessage() {
    setState(() {
      _messages.add(ChatMessage(
        ...
        characterIcon: widget.character.userIcon,
      ));
    });
    _scrollToBottom();
  }
